#ifndef HALIDE__bin___blur_h
#define HALIDE__bin___blur_h
#include <stdint.h>
...
int blur(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_result_buffer);

HALIDE_FUNCTION_ATTRS
int blur_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *blur_metadata();
